...
struct Turbulence *TrbNew(void)
{
  ...
  turbulence->amplitude  = Vector(1, 1, 1);
  turbulence->frequency  = Vector(1, 1, 1);
  turbulence->offset     = Vector(0, 0, 0);
