...
#Procedure
si.NewProcedure('xyzrgb_dragon_proc', 'stanfordply_procedure')
si.AssignMesh('xyzrgb_dragon_proc', 'mesh', 'xyzrgb_dragon_mesh')
si.SetStringProperty('xyzrgb_dragon_proc', 'filepath', '../../ply/xyzrgb_dragon.ply')
si.SetStringProperty('xyzrgb_dragon_proc', 'io_mode', 'r')
si.RunProcedure('xyzrgb_dragon_proc')
